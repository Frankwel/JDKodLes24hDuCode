...
public class BrowserContextSample {
    public static void main(String[] args) {
        ...
        Browser browserOne = new Browser(new BrowserContext(new BrowserContextParams(browserOneUserDataDir)));
        ...
        Browser browserTwo = new Browser(new BrowserContext(new BrowserContextParams(browserTwoUserDataDir)));
