...
public class JavaFXFileUploadSample extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        browser.setDialogHandler(new DefaultDialogHandler(view) {
            ...
            public CloseStatus onFileChooser(final FileChooserParams params) {
                AtomicReference<CloseStatus> result = new AtomicReference<CloseStatus>(CloseStatus.CANCEL);
    ...
    private static void displayFileChooserDialog(final FileChooserParams params, final AtomicReference<CloseStatus> result, final BrowserView view) {
